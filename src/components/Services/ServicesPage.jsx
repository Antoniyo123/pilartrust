...
const ServicesPage = () => {
  ...
  return (
    <div className="services-page">
      ...
      {/* ── Hero ── */}
      <section className="svc-hero-area">
        <div className="svc-container">
          <div className="svc-hero-layout">
            <div className="svc-hero-col-left">
              <span className="svc-badge-label">Our Services</span>
              <h1 className="svc-hero-heading">
                Comprehensive <em>security solutions</em> for your digital transformation
              </h1>
            </div>
            <div className="svc-hero-col-right">
      ...
      {/* ── Overview ── */}
      <section className="svc-metrics-area">
        <div className="svc-container">
          <div className="svc-metrics-layout">
            <div className="svc-metric-box">
              <div className="svc-metric-value">5+</div>
              <p className="svc-metric-name">Core Services</p>
            </div>
            <div className="svc-metric-box">
              <div className="svc-metric-value">100+</div>
              <p className="svc-metric-name">Projects Completed</p>
            </div>
            <div className="svc-metric-box">
              <div className="svc-metric-value">50+</div>
              <p className="svc-metric-name">Satisfied Clients</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ── Services Detail ── */}
      <section className="svc-portfolio-area">
        <div className="svc-container">
          <div className="svc-portfolio-intro">
            <span className="svc-intro-badge">What We Offer</span>
            <h2 className="svc-intro-heading">Our <em>Services Portfolio</em></h2>
          </div>
          ...
          <div className="svc-tabs-wrapper">
            {services.map((service, index) => (
              <button
                key={index}
                className={`svc-tab-button ${activeService === index ? 'is-active' : ''}`}
                onClick={() => setActiveService(index)}
              >
                <div className="svc-tab-icon">{service.icon}</div>
                <span className="svc-tab-num">{service.number}</span>
                <span className="svc-tab-name">{service.title}</span>
              </button>
            ))}
          </div>

          <div className="svc-display-panel">
            <div className="svc-panel-media">
              <div className="svc-media-frame">
                <img 
                  src={services[activeService].image} 
                  alt={services[activeService].title}
                  className="svc-media-photo"
                />
                <div className="svc-media-badge">
                  <div className="svc-badge-icon">{services[activeService].icon}</div>
                </div>
              </div>
              <div className="svc-stats-bar">
                <div className="svc-stats-unit">
                  <div className="svc-stats-figure">{services[activeService].stats.projects}</div>
                  <div className="svc-stats-caption">Projects</div>
                </div>
                <div className="svc-stats-separator"></div>
                <div className="svc-stats-unit">
                  <div className="svc-stats-figure">{services[activeService].stats.clients}</div>
                  <div className="svc-stats-caption">Clients</div>
                </div>
                <div className="svc-stats-separator"></div>
                <div className="svc-stats-unit">
                  <div className="svc-stats-figure">{services[activeService].stats.success}</div>
                  <div className="svc-stats-caption">Success Rate</div>
                </div>
              </div>
            </div>

            <div className="svc-panel-details">
              <div className="svc-details-top">
                <div className="svc-details-num">{services[activeService].number}</div>
                <div className="svc-details-titles">
                  <h3 className="svc-details-heading">{services[activeService].title}</h3>
                  <p className="svc-details-subhead">{services[activeService].subtitle}</p>
                </div>
              </div>
              <p className="svc-details-description">{services[activeService].description}</p>
              <div className="svc-info-blocks">
                <div className="svc-info-block">
                  <h4 className="svc-block-title">Key Features</h4>
                  <ul className="svc-feature-list">
                    {services[activeService].features.map((feature, idx) => (
                      <li key={idx} className="svc-feature-item">{feature}</li>
                    ))}
                  </ul>
                </div>
                <div className="svc-info-block">
                  <h4 className="svc-block-title">Benefits</h4>
                  <ul className="svc-feature-list svc-benefit-list">
                    {services[activeService].benefits.map((benefit, idx) => (
                      <li key={idx} className="svc-feature-item">{benefit}</li>
                    ))}
                  </ul>
                </div>
              </div>
      ...
      {/* ── Why Choose Us ── */}
      <section className="svc-why-area">
        <div className="svc-container">
          <div className="svc-why-layout">
            <div className="svc-why-intro">
              <span className="svc-intro-badge">Why Choose Us</span>
              <h2 className="svc-why-headline">
                Your trusted partner in <em>cybersecurity excellence</em>
              </h2>
              <p className="svc-why-tagline">
              ...
              <div className="svc-why-metrics">
                <div className="svc-why-metric">
                  <div className="svc-why-metric-num">15+</div>
                  <div className="svc-why-metric-label">Years Experience</div>
                </div>
                <div className="svc-why-metric-divider"></div>
                <div className="svc-why-metric">
                  <div className="svc-why-metric-num">100%</div>
                  <div className="svc-why-metric-label">Client Satisfaction</div>
                </div>
              </div>
            </div>
            <div className="svc-why-right">
              <div className="svc-features-grid">
                <div className="svc-feature-card">
                  ...
                  <h3 className="svc-card-heading">Certified Professionals</h3>
                ...
                <div className="svc-feature-card">
                  ...
                  <h3 className="svc-card-heading">Proven Methodology</h3>
                  <p className="svc-card-text">
                ...
                <div className="svc-feature-card">
                  ...
                  <h3 className="svc-card-heading">Customized Solutions</h3>
                  <p className="svc-card-text">
                ...
                <div className="svc-feature-card">
                  ...
                  <h3 className="svc-card-heading">Continuous Support</h3>
                  <p className="svc-card-text">
      ...
      <section className="svc-clients-area">
        <div className="svc-container">
          ...
          {/* Header */}
          <div className="svc-clients-intro">
            <span className="svc-intro-badge">Our Clients</span>
            <h2 className="svc-intro-heading">Trusted by <em>leading organizations</em></h2>
            <p className="svc-clients-tagline">
          ...
          {/* Bottom stats strip */}
          <div className="svc-clients-stats">
            <div className="svc-clients-stat">
              <span className="svc-clients-stat-num">8</span>
              <span className="svc-clients-stat-label">Kategori Industri</span>
            </div>
            <div className="svc-clients-stat-divider"></div>
            <div className="svc-clients-stat">
              <span className="svc-clients-stat-num">50+</span>
              <span className="svc-clients-stat-label">Klien Aktif</span>
            </div>
            <div className="svc-clients-stat-divider"></div>
            <div className="svc-clients-stat">
              <span className="svc-clients-stat-num">100%</span>
              <span className="svc-clients-stat-label">Kepuasan Klien</span>
            </div>
          </div>
        </div>
      </section>
